...
extern EXPORT int playWave3D(const char *lpszWAVEFileName, const double src[3], const double org[3], const double pyr[3], double vol, double attn, double delay, bool loop = false);
extern EXPORT int playWave3DPitch(const char *lpszWAVEFileName, const double src[3], const double org[3], const double pyr[3], double vol, double attn, double delay, unsigned short pitch, bool loop = false);
