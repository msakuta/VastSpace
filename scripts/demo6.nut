...
deltaFormation("ContainerHead", 0, Quatd(0,0,0,1), Vec3d(0, 0., 0.), 0.15, 1, player.cs, null);
...
deltaFormation("Attacker", 0, Quatd(0,0,0,1), Vec3d(-1., 0.1, 0.), 0.5, 1, player.cs, null);
