...
deltaFormation("Sceptor", 0, Quatd(0,1,0,0), Vec3d(0, 0., -2.025), 0.025, 20, player.cs, null);
deltaFormation("Destroyer", 1, Quatd(0,0,0,1), Vec3d(0, 0., -0.5), 0.500, 1, player.cs, null);
