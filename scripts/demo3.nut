...
deltaFormation("Sceptor", 0, Quatd(0,1,0,0), Vec3d(0, 0., -1025.), 25., 10, player.cs, null);
deltaFormation("DestroyerMissile", 1, Quatd(0,0,0,1), Vec3d(0, 0., 1000.), 500., 1, player.cs, null);
