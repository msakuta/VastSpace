...
hitbox <- [
	[Vec3d(0., 0., 0.000), Quatd(0,0,0,1), Vec3d(0.015, 0.014, 0.050)], // body
	[Vec3d(0., 0., -0.075), Quatd(0,0,0,1), Vec3d(0.002, 0.002, 0.025)], // gun
	[Vec3d(0., 0.018, 0.0325), Quatd(0,0,0,1), Vec3d(0.010, 0.004, 0.015)], // bridge
	[Vec3d(0.025, -0.015, 0.02), Quatd(0,0, -SIN15, COS15), Vec3d(0.0075, 0.002, 0.02)], // wings
